...
def route_classified_error(
    ...
    if _should_fallback and agent._fallback_index < len(agent._fallback_chain):
        ...
        # Z.AI Coding Plan overload is an upstream service condition, not a
        # bad credential. Never wait for a multi-key pool to rotate through
        # the same overloaded endpoint; switch to the configured fallback
        # chain after the short retry window instead.
        pool_may_recover = (
