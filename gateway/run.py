...
def _start_gateway_make_shutdown_signal_handler(runner, _signal_initiated_shutdown: list):
    ...
    def shutdown_signal_handler(received_signal=None):
        ...
        # Taken BEFORE the planned-stop/takeover markers are consumed: the marker carries the
        # initiating CLI argv and is the only durable attribution once an update/restart helper exits.
        def _snapshot():
