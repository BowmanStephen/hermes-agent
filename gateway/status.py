...
def _build_pid_record() -> dict:
    ...
    return {
        "pid": os.getpid(), "kind": _GATEWAY_KIND, "argv": redact_command_argv(sys.argv),
...
def write_planned_stop_marker(target_pid: int) -> bool:
    ...
    return _write_marker(_get_planned_stop_marker_path(), {
        ...
        # Preserve command/flag attribution without persisting sensitive option values such as
        # the argument to --key.
