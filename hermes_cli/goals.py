...
# Judge models sometimes use a natural-language equivalent instead of the canonical ``blocked``
# verdict. Normalize those aliases at the parser edge so every consumer sees one stable
# state-machine value.
_BLOCKED_VERDICT_ALIASES = frozenset({
    "stuck", "stalled", "unachievable", "impossible", "needs_user", "needs_user_input",
    "needs_input", "requires_user", "requires_human",
})
