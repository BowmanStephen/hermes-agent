...
_CANONICAL_TABLES = (
    "system_prompts", "sessions", "messages", "session_model_usage", "task_telemetry", "compression_locks",
    "gateway_routing",
    "async_delegations",
)
...
_DEPENDENT_TABLES = (
    "messages", "session_model_usage", "task_telemetry", "compression_locks", "telegram_dm_topic_bindings",
)
