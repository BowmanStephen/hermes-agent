...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    # working clone collapsed to a single commit three times on 2026-08-19). Only trust the flag
    # when the history really is a stub.
    ...
    # Belt and braces: under pytest these fetches run against the developer's real PROJECT_ROOT, and a
