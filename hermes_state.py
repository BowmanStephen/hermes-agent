...
class SessionDB(
    ...
    _TOKEN_DELTA_ROUTE_FIELDS = (
        ...
        "billing_mode", "task_id", "turn_id", "source",
    )

    # ── Task telemetry (fork: task cost / outcome insights, d2d2f40e87) ──
    # Turn-boundary rows live here; per-API-call deltas are appended from
    # update_token_counts via _record_task_telemetry_delta.
    @staticmethod
