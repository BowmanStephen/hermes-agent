...
class SessionUsageMixin:
    ...
    def update_token_counts(
        ...
        task_id: Optional[str]=None, turn_id: Optional[str]=None, api_latency_ms: float=0.0,
        ...
        def _do(conn):
            ...
            # Per-task/turn cost + outcome telemetry (local Insights). Only the
            # incremental path carries attributable deltas.
