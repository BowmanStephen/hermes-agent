...
class TestFormatters:
    ...
    def test_format_context_never_renders_parent_argv(self):
        """Secrets in the parent command line must never reach the shutdown
        log line. Upstream renders parent identity (pid/name) only — argv is
        omitted outright, which supersedes the fork's per-option redaction."""
        ...
        assert "gateway run" not in rendered
