...
class TestCallbackWiringOrder:
    ...
    def test_callback_set_before_join(self):
        ...
        import ast, inspect
        from gateway.command_handlers.voice import VoiceGatewayCommands
        source = inspect.getsource(VoiceGatewayCommands._handle_voice_channel_join)
        lines = source.split("\n")
        callback_line = None
        join_line = None
...
class TestSendVoiceReplyFilename:
    ...
    def test_filename_uses_uuid(self):
        ...
        import inspect
        from gateway.command_handlers.voice import VoiceGatewayCommands
        source = inspect.getsource(VoiceGatewayCommands._send_voice_reply)
...
class TestSendVoiceReplyCleanup:
    ...
    def test_cleanup_in_finally(self):
        ...
        from gateway.command_handlers.voice import VoiceGatewayCommands
        source = textwrap.dedent(inspect.getsource(VoiceGatewayCommands._send_voice_reply))
        tree = ast.parse(source)
        func = tree.body[0]
