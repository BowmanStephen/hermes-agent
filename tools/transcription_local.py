...
def _load_local_whisper_model(model_name: str, device: str = "auto", compute_type: str = "auto"):
    ...
    if force_cpu:
        ...
        effective_compute_type = (
            "int8" if requested_compute_type.lower() == "auto" else requested_compute_type
        )
        ...
        return _create_whisper_model(model_name, device="cpu", compute_type=effective_compute_type)
    try:
